...
All planned features have been successfully implemented in the `src/` directory.
...
{
  "scripts": {
    "test:v2": "jest --config src/jest.config.js",
    "test:v2:unit": "jest --config src/jest.config.js src/__tests__/unit",
    "test:v2:integration": "jest --config src/jest.config.js src/__tests__/integration",
    "test:v2:coverage": "jest --config src/jest.config.js --coverage"
  }
}
```
...
Comprehensive documentation has been created in `src/README.md` including:
