// src/checkout/ia-pre-authorization.js
// User-friendly iaPreAuthorization function for myPOS SDK
...
/**
 * User-facing iaPreAuthorization function
...
async function iaPreAuthorization(params = {}) {
  ...
  return new Promise((resolve, reject) => {
    const req = new CheckoutIAPreAuthorizationRequest(mypos, requestParams);
